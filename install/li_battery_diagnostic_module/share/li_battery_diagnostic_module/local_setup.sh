...
: ${AMENT_CURRENT_PREFIX:="/root/li_battery_ws/install/li_battery_diagnostic_module"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/li_battery_diagnostic_module/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/li_battery_diagnostic_module/environment/path.sh"
